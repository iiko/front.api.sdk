...
namespace Resto.Front.Api.SamplePlugin
{
    ...
    public sealed partial class SamplePlugin : IFrontPlugin
    {
        ...
        public SamplePlugin()
        {
            ...
            ResetMaxKnownVersionedEntityRevisionIfRequired();
            ...
            //subscriptions.Push(ExternalNotificationsTester.Test());
            ...
            //subscriptions.Push(MarkingCodesHandler.Register());
            ...
            //subscriptions.Push(new NotificationHandlers.BeforeAddOrderItemsHandler());
            //subscriptions.Push(new NotificationHandlers.GetEInvoiceNumberHandler());
            //subscriptions.Push(new NotificationHandlers.ConfirmEInvoiceNumberProcessedHandler());
            //subscriptions.Push(new NotificationHandlers.CardScannedHandler());
            ...
            //subscriptions.Push(new PrintTester());
            //subscriptions.Push(new DeviceTester());

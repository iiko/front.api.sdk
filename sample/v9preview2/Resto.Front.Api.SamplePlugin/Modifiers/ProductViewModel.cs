...
namespace Resto.Front.Api.SamplePlugin.Modifiers
{
    internal class ProductViewModel : TreeNodeViewModel
    {
        ...
        public IMeasuringUnit MeasuringUnit => product.MeasuringUnit;
        ...
        public decimal FoodValueFat => product.FoodValue.Fat;
        public decimal FoodValueProtein => product.FoodValue.Protein;
        public decimal FoodValueCarbohydrate => product.FoodValue.Carbohydrate;
        public decimal FoodValueCaloricity => product.FoodValue.Caloricity;
        ...
        public string UzFiscalCode => product.UzFiscalCode;

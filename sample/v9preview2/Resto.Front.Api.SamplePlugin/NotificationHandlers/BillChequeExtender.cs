...
namespace Resto.Front.Api.SamplePlugin.NotificationHandlers
{
    ...
    internal sealed class BillChequeExtender : IDisposable
    {
        ...
        /// </summary>        
        [NotNull]
        private ChequeExtensions AddBillChequeExtensions(Guid orderId)
        {
        ...
        [NotNull]
        private static ChequeExtensions AddUniqueChequeExtensions(int chequeNumber)
        {
            var billCheque = new ChequeExtensions
            {
        ...
        [NotNull]
        private static ChequeExtensions AddDuplicatedChequeExtensions(int chequeNumber)
        {

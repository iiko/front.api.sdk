...
namespace Resto.Front.Api.SamplePlugin.Restaurant
{
    internal sealed class ProductModel : MenuItemModel
    {
        ...
        public Color Background => Product.BackgroundColor ?? new Color(System.Drawing.Color.WhiteSmoke.ToArgb());
        public Color Foreground => Product.FontColor ?? new Color(System.Drawing.Color.Black.ToArgb());

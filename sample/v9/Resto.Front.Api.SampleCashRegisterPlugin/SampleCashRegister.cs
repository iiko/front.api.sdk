...
{
    internal sealed class SampleCashRegister : Devices.IFfdCashRegister
    {
        ...
        {
            PluginContext.Log.WarnFormat("Device: '{0} ({1})' DoFfd10Correction not supported.", DeviceName, deviceId);
            throw new NotImplementedException();
        }

        public CashRegisterResult DoFfd11Correction(Ffd11CorrectionTask task, IUser cashier, IViewManager viewManager)
        {
            PluginContext.Log.WarnFormat("Device: '{0} ({1})' DoFfd11Correction not supported.", DeviceName, deviceId);
            throw new NotImplementedException();
        }

        public FiscalTagsResult GetDocumentFiscalTags(GetFiscalTagsTask task, IUser cashier)
        {
            PluginContext.Log.WarnFormat("Device: '{0} ({1})' GetDocumentFiscalTags not supported.", DeviceName, deviceId);
            throw new NotImplementedException();
        }

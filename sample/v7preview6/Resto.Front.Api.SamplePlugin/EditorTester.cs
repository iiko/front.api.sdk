...
namespace Resto.Front.Api.SamplePlugin
{
    internal sealed class EditorTester : IDisposable
    {
        ...
        {
            var credentials = os.GetCredentials();
            var client = os.SearchClients("Semen").Last();
        ...
        {
            os.AddOrderExternalData(PluginName, "Sample plugin external data", order, os.GetCredentials());

            var value = os.TryGetOrderExternalDataByKey(order.Id, PluginName);

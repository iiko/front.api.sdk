...
namespace Resto.Front.Api.SamplePaymentPlugin
{
    internal sealed class PaymentEditorTester : IDisposable
    {
        ...
        {
            var deliveryOrder = PluginContext.Operations.GetOrders().Last(o => o.Status == OrderStatus.New);
            var paymentType = PluginContext.Operations.GetPaymentTypes().First(x => x.Kind == PaymentTypeKind.Cash);
            PluginContext.Operations.AddPaymentItem(50, null, paymentType, deliveryOrder, PluginContext.Operations.GetCredentials());
        }
        ...
        private void AddCardPayment()
        {
            ...
            PluginContext.Operations.AddPaymentItem(50, additionalData, paymentType, deliveryOrder, PluginContext.Operations.GetCredentials());
        }
        ...
        private void DeletePreliminaryPayment()
        {
            ...
            var paymentItem = order.Payments.First(i => i.IsPreliminary);

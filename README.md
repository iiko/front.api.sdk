...
# Getting started #
iikoFront Api is based on .Net Framework 4.6.1 and provides a set of interfaces and classes. Basically you should create a class library, add a reference to the _Resto.Front.Api.Vx.dll_ and implement `IFrontPlugin` interface: 
...
- [Code reference API V4](https://iiko.github.io/front.api.sdk/v4/) (obsolete).
- [Code reference API V5](https://iiko.github.io/front.api.sdk/v5/) (current).
- [Code reference API V6](https://iiko.github.io/front.api.sdk/v6/) (preview).
